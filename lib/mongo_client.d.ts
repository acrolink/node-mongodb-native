...
import { type LogComponentSeveritiesClientOptions, type MongoDBLogWritable, MongoLogger, type MongoLoggerOptions } from './mongo_logger';
import { TypedEventEmitter } from './mongo_types';
import { type ClientBulkWriteModel, type ClientBulkWriteOptions, type ClientBulkWriteResult } from './operations/client_bulk_write/common';
...
import { type HostAddress, type MongoDBNamespace } from './utils';
...
export declare class MongoClient extends TypedEventEmitter<MongoClientEvents> implements AsyncDisposable {
    ...
    topology?: Topology;
    /** @internal */
    readonly mongoLogger: MongoLogger | undefined;
    /** @internal */
