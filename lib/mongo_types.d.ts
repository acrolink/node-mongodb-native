...
import type { Binary, BSONRegExp, BSONType, Decimal128, Document, Double, Int32, Long, ObjectId, ObjectIdLike, Timestamp } from './bson';
...
/** @public */
export type OnlyFieldsOfType<TSchema, FieldType = any, AssignableType = FieldType> = IsAny<TSchema[keyof TSchema], AssignableType extends FieldType ? Record<string, FieldType> : Record<string, AssignableType>, AcceptedFields<TSchema, FieldType, AssignableType> & NotAcceptedFields<TSchema, FieldType> & Record<string, AssignableType>>;
/** @public */
...
export declare class TypedEventEmitter<Events extends EventsDescription> extends EventEmitter {
    ...
    /** @internal */
    emitAndLog<EventKey extends keyof Events>(event: EventKey | symbol, ...args: Parameters<Events[EventKey]>): void;
    /** @internal */
    emitAndLogHeartbeat<EventKey extends keyof Events>(event: EventKey | symbol, topologyId: number, serverConnectionId?: number | '<monitor>', ...args: Parameters<Events[EventKey]>): void;
    /** @internal */
    emitAndLogCommand<EventKey extends keyof Events>(monitorCommands: boolean, event: EventKey | symbol, databaseName: string, connectionEstablished: boolean, ...args: Parameters<Events[EventKey]>): void;
}
/** @public */
 ...
 */
export type NestedPaths<Type, Depth extends number[]> = Depth['length'] extends 8 ? [] : Type extends string | number | bigint | boolean | Date | RegExp | Buffer | Uint8Array | ((...args: any[]) => any) | {
    _bsontype: string;
